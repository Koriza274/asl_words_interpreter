...
from functions.augmentation import normalize_frame, augment_frame

video_folder = "raw_data/ASL/videos"

output_folder = "functions/output"
os.makedirs(output_folder, exist_ok=True)
output_npy = "functions/output/npy"
...
train_df = pd.read_csv("raw_data/ASL/splits/train.csv")
